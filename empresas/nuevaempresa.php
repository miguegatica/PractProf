...
if(isset($_POST['guardar'])){
    ...
    $insertarempresa = $conn->prepare('INSERT INTO empresas (nombre, bd) VALUES (:nombre, :bd) ');
...
<body>
 ...
 <nav id="menu">
           <ul>
               <li><a href="#">Recibir contraseña</a></li>
...
<!--<!<html>
    ...
    <body>
        <form action="nuevaempresa.php" method="POST">
            nombre:<input type="text" name="companyname">
            bd:<input type="text" name="companyname">
            CUIT:<input type="text" name="companyname">
            IVA:<input type="text" name="companyname">
            direccion:<input type="text" name="companyname">
            telefono:<input type="text" name="companyname">
